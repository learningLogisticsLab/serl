...
class MemoryEfficientFractalReplayBufferDataStore(MemoryEfficientReplayBuffer, DataStoreBase):
    def __init__(
        self,
        observation_space: gym.Space,
        action_space: gym.Space,
...
class FractalSymmetryReplayBufferDataStore(FractalSymmetryReplayBuffer, DataStoreBase):
    def __init__(
        self,
        observation_space: gym.Space,
        action_space: gym.Space,
        ...
        **kwargs: dict,
        ...
        FractalSymmetryReplayBuffer.__init__(self, observation_space, action_space, capacity, workspace_width, x_obs_idx, y_obs_idx, branch_method, split_method, workspace_width_method,**kwargs)
        DataStoreBase.__init__(self, capacity)
        self._lock = Lock()
        self._logger = None
    ...
    def insert(self, data):
        with self._lock:
            super(FractalSymmetryReplayBufferDataStore, self).insert(data)
