...
from serl_launcher.data.fractal_ker_replay_buffer import FractalKerReplayBuffer
...
def main(_):
    ...
    transformed_data_dicts = buffer.insert(generated_dict)
