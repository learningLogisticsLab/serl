...
from franka_sim.wrappers.hil_wrappers import (
...
from franka_sim.wrappers.viewer_wrapper import PassiveViewerWrapper
...
def make_env(
    ...
    **kwargs,
    ...
    if env_id == "franka_sim/PandaPickCube-v0":
        env = PandaPickCubeGymEnv(**kwargs)
    elif env_id == "franka_sim/PandaReachCube-v0":
        env = PandaReachCubeGymEnv(**kwargs)
    else:
